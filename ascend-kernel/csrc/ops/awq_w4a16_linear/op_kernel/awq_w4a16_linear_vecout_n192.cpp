...
namespace AwqW4A16LinearVecoutN192 {
...
constexpr uint32_t BasicK = 64;
constexpr uint32_t TileN = 192;
...
static_assert(SecondVectorCols == 64, "The N192 kernel expects a 128+64 vector split.");
...
extern "C" __global__ __aicore__ void awq_w4a16_linear_vecout_n192(
    ...
    uint32_t colOffset, GM_ADDR workspace, GM_ADDR tilingGm)
{
    ...
    AwqW4A16LinearVecoutN192::Kernel kernel;

...
description: >-
  排查并优化 Ascend C 算子性能。当用户开发、审查或优化 Ascend C kernel
  算子时使用，或当用户提及 Ascend C 性能优化、算子优化、tiling、流水、搬运、
  内存优化、NPU/昇腾等关键词时触发。
---
...
当目标设备是远端 910B2C / `Ascend910_9382`，或遇到 `GetTiling failed`、
`507015`、VECOUT/TSCM 资源边界、Matmul shape 合法性、queue buffer 数量、
workspace/EventID 竞争等问题时，额外读取
[references/ascend910-9382-resource-map.md](references/ascend910-9382-resource-map.md)。

# \_\_half2int\_rn<a name="ZH-CN_TOPIC_0000002501269948"></a>
...
将half类型数据转换为有符号整数，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int __half2int_rn(const half x)
```
...
输入转换为有符号整数并四舍五入到最接近的偶数的结果。特别场景说明如下：

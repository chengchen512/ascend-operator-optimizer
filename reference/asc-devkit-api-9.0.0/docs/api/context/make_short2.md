# make\_short2<a name="ZH-CN_TOPIC_0000002546527531"></a>
...
```
__simt_callee__ inline short2 make_short2(short x, short y)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_short2(__gm__ short2* dst, __gm__ short* x, __gm__ short* y)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_short2(x[idx], y[idx]);
}
```

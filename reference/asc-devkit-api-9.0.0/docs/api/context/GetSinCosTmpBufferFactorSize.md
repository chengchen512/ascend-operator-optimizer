# GetSinCosTmpBufferFactorSize<a name="ZH-CN_TOPIC_0000002382729973"></a>

## 功能说明<a name="section3357103620506"></a>
...
## 函数原型<a name="section17136021155010"></a>
...
## 参数说明<a name="section1892716239502"></a>
...
<tbody><tr id="row83132711300"><td class="cellrowborder" valign="top" width="16.89%" headers="mcps1.2.4.1.1 "><p id="p183110271304"><a name="p183110271304"></a><a name="p183110271304"></a>ascendcPlatform</p>
</td>
<td class="cellrowborder" valign="top" width="13.19%" headers="mcps1.2.4.1.2 "><p id="p03132710304"><a name="p03132710304"></a><a name="p03132710304"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="69.92%" headers="mcps1.2.4.1.3 "><p id="p432427153017"><a name="p432427153017"></a><a name="p432427153017"></a>输入的平台信息。PlatformAscendC的定义请参见<a href="构造及析构函数.md">构造及析构函数</a>。</p>
</td>
</tr>

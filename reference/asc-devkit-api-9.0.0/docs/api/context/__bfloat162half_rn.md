# \_\_bfloat162half\_rn<a name="ZH-CN_TOPIC_0000002501269954"></a>
...
将bfloat16类型数据转换为half类型数据，并四舍五入到最接近的偶数，返回转换后的值。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __bfloat162half_rn(const bfloat16_t x)
```
...
输入转换为half类型，并四舍五入到最接近的偶数的结果。特别场景说明如下：

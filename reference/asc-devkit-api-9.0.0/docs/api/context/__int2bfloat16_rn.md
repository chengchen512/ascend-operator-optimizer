# \_\_int2bfloat16\_rn<a name="ZH-CN_TOPIC_0000002501429828"></a>
...
将int32类型数据转换为bfloat16类型数据，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __int2bfloat16_rn(const int x)
```

# \_\_int2half\_rna<a name="ZH-CN_TOPIC_0000002513360138"></a>
...
将int32类型数据转换为向远离零方向舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_rna(const int x)
```

# \_\_int2float\_ru<a name="ZH-CN_TOPIC_0000002501269972"></a>
...
将int32类型数据转换为向上取整的浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __int2float_ru(const int x)
```

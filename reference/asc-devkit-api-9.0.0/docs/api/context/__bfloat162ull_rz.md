# \_\_bfloat162ull\_rz<a name="ZH-CN_TOPIC_0000002533069819"></a>
...
将bfloat16类型数据转换为向零舍入的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __bfloat162ull_rz(const bfloat16_t x)
```

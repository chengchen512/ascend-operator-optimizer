# \_\_uint2half\_rna<a name="ZH-CN_TOPIC_0000002513200214"></a>
...
将uint32类型数据转换为向远离零方向舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __uint2half_rna(const unsigned int x)
```
...
输入的uint32数据转换成的向远离零方向舍入的half数据。

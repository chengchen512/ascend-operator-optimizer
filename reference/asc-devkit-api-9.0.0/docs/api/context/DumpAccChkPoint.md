...
<p id="p77061421432"><a name="p77061421432"></a><a name="p77061421432"></a><span id="ph19309653331"><a name="ph19309653331"></a><a name="ph19309653331"></a>Kirin X90</span>，支持的数据类型为：bool、uint8_t、int8_t、int16_t、uint16_t、int32_t、uint32_t、int64_t、uint64_t、float、half。</p>
<p id="p54761433431"><a name="p54761433431"></a><a name="p54761433431"></a><span id="ph8583115613314"><a name="ph8583115613314"></a><a name="ph8583115613314"></a>Kirin 9030</span>，支持的数据类型为：bool、uint8_t、int8_t、int16_t、uint16_t、int32_t、uint32_t、int64_t、uint64_t、float、half。</p>
</td>
</tr>
</tbody>
</table>

# make\_int3<a name="ZH-CN_TOPIC_0000002514967612"></a>
...
使用给定的两个int类型的数据创建一个int3类型的向量。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int3 make_int3(int x, int y, int z)
```
...
<tr id="row158751888316"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.2.4.1.1 "><p id="p428251115313"><a name="p428251115313"></a><a name="p428251115313"></a>z</p>
</td>
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_int3(__gm__ int3* dst, __gm__ int* x, __gm__ int* y, __gm__ int* z)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_int3(x[idx], y[idx], z[idx]);
}
```

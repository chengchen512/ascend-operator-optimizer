# \_\_int2half\_rn<a name="ZH-CN_TOPIC_0000002501429826"></a>
...
将int32类型数据转换为half，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_rn(const int x)
```
...
输入的int32数据转换成的half数据，并四舍五入到最接近的偶数。

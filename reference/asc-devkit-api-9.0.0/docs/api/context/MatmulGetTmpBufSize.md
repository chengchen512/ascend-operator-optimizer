# MatmulGetTmpBufSize<a name="ZH-CN_TOPIC_0000001649369833"></a>

## 功能说明<a name="section618mcpsimp"></a>

本接口用于在调用[GetTiling](GetTiling.md)接口获取Tiling参数后，根据Tiling结构体信息获取L1 Buffer/Unified Buffer/L0C Buffer的使用大小。
...
<td class="cellrowborder" valign="top" width="72.99%" headers="mcps1.2.4.1.3 "><p id="p079542010383"><a name="p079542010383"></a><a name="p079542010383"></a>Matmul单核Tiling的结构体，即MatmulTiling对象得到的TCubeTiling结构体。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="72.99%" headers="mcps1.2.4.1.3 "><p id="p1150725719147"><a name="p1150725719147"></a><a name="p1150725719147"></a>Tiling中<span id="ph1311394162617"><a name="ph1311394162617"></a><a name="ph1311394162617"></a>L1 Buffer</span>/<span id="ph1611314412265"><a name="ph1611314412265"></a><a name="ph1611314412265"></a>Unified Buffer</span>/<span id="ph6113174112619"><a name="ph6113174112619"></a><a name="ph6113174112619"></a>L0C Buffer</span>的使用大小。</p>

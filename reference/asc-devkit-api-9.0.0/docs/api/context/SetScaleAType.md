# SetScaleAType<a name="ZH-CN_TOPIC_0000002264206153"></a>
...
<td class="cellrowborder" valign="top" width="73.03%" headers="mcps1.2.4.1.3 "><p id="p126441432182115"><a name="p126441432182115"></a><a name="p126441432182115"></a>scaleA矩阵的内存逻辑位置。</p>
<p id="p11644432192117"><a name="p11644432192117"></a><a name="p11644432192117"></a>针对<span id="ph1788095712378"><a name="ph1788095712378"></a><a name="ph1788095712378"></a>Ascend 950PR/Ascend 950DT</span>，scaleA矩阵可设置为TPosition::GM，TPosition::VECOUT，TPosition::TSCM。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="73.03%" headers="mcps1.2.4.1.3 "><p id="p6310416287"><a name="p6310416287"></a><a name="p6310416287"></a>scaleA矩阵的物理排布格式。</p>
<p id="p1175934213209"><a name="p1175934213209"></a><a name="p1175934213209"></a>针对<span id="ph1712219180275"><a name="ph1712219180275"></a><a name="ph1712219180275"></a>Ascend 950PR/Ascend 950DT</span>，scaleA矩阵可设置为CubeFormat::ND，CubeFormat::NZ。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="73.03%" headers="mcps1.2.4.1.3 "><p id="p6934203185911"><a name="p6934203185911"></a><a name="p6934203185911"></a>scaleA矩阵是否转置。参数支持的取值如下：</p>
<a name="ul14410201292516"></a><a name="ul14410201292516"></a><ul id="ul14410201292516"><li>true：scaleA矩阵转置；</li><li>false：默认值，scaleA矩阵不转置。</li></ul>
</td>
</tr>
</tbody>
</table>

# GetBatchTensorC<a name="ZH-CN_TOPIC_0000002061229326"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p155981937194715"><a name="p155981937194715"></a><a name="p155981937194715"></a>当前仅支持异步模式，即该参数只支持取值为false。</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="row964714433565"><th class="cellrowborder" valign="top" width="18.7%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0235751031_p20917673"><a name="zh-cn_topic_0235751031_p20917673"></a><a name="zh-cn_topic_0235751031_p20917673"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="14.099999999999998%" id="mcps1.2.4.1.2"><p id="zh-cn_topic_0235751031_p16609919"><a name="zh-cn_topic_0235751031_p16609919"></a><a name="zh-cn_topic_0235751031_p16609919"></a>输入/输出</p>
</th>
...
<tbody><tr id="row65521150131316"><td class="cellrowborder" valign="top" width="18.7%" headers="mcps1.2.4.1.1 "><p id="p1755219506135"><a name="p1755219506135"></a><a name="p1755219506135"></a>batchA</p>
</td>
<td class="cellrowborder" valign="top" width="14.099999999999998%" headers="mcps1.2.4.1.2 "><p id="p14553350121317"><a name="p14553350121317"></a><a name="p14553350121317"></a>输入</p>
</td>
...
<tr id="row1997242710146"><td class="cellrowborder" valign="top" width="18.7%" headers="mcps1.2.4.1.1 "><p id="p69731527181417"><a name="p69731527181417"></a><a name="p69731527181417"></a>batchB</p>
</td>
<td class="cellrowborder" valign="top" width="14.099999999999998%" headers="mcps1.2.4.1.2 "><p id="p10973152711411"><a name="p10973152711411"></a><a name="p10973152711411"></a>输入</p>
</td>
...
<tr id="row6652117123"><td class="cellrowborder" valign="top" width="18.7%" headers="mcps1.2.4.1.1 "><p id="p1733933012128"><a name="p1733933012128"></a><a name="p1733933012128"></a>enSequentialWrite</p>
</td>
<td class="cellrowborder" valign="top" width="14.099999999999998%" headers="mcps1.2.4.1.2 "><p id="p1233993014123"><a name="p1233993014123"></a><a name="p1233993014123"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="67.2%" headers="mcps1.2.4.1.3 "><p id="p171307421531"><a name="p171307421531"></a><a name="p171307421531"></a>该参数预留，保持默认值false即可。</p>
</td>
</tr>
<tr id="row10651193853020"><td class="cellrowborder" valign="top" width="18.7%" headers="mcps1.2.4.1.1 "><p id="p11651138123018"><a name="p11651138123018"></a><a name="p11651138123018"></a>c</p>
</td>
<td class="cellrowborder" valign="top" width="14.099999999999998%" headers="mcps1.2.4.1.2 "><p id="p465110382303"><a name="p465110382303"></a><a name="p465110382303"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="67.2%" headers="mcps1.2.4.1.3 "><p id="p1165193813014"><a name="p1165193813014"></a><a name="p1165193813014"></a>C矩阵放置于Local Memory的地址，用于保存矩阵分片。</p>
</td>
</tr>
</tbody>
</table>

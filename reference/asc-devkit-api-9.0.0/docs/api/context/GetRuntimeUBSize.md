# GetRuntimeUBSize<a name="ZH-CN_TOPIC_0000002483922570"></a>
...
本调用示例通过GetRuntimeUBSize获取的UB空间大小，来计算tileNum的值，完整的算子样例参考：[算子样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/02_features/15_utility_function/get_runtime_ub_size)。

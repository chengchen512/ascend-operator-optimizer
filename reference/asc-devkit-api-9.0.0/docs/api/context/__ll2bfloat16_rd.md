# \_\_ll2bfloat16\_rd<a name="ZH-CN_TOPIC_0000002501270000"></a>
...
将int64类型数据向下取整转换为bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __ll2bfloat16_rd(const long long int x)
```

# \_\_ll2float\_rna<a name="ZH-CN_TOPIC_0000002513200218"></a>
...
将int64类型数据转换为向远离零方向舍入的浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __ll2float_rna(const long long int x)
```

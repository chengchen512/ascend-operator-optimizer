# lrintf<a name="ZH-CN_TOPIC_0000002519060927"></a>
...
```
__simt_vf__ __launch_bounds__(1024) inline void KernelRint(__gm__ long int* dst, __gm__ float* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = lrintf(x[idx]);
}
```

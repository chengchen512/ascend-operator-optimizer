# \_\_bfloat162int\_ru<a name="ZH-CN_TOPIC_0000002501269960"></a>
...
将bfloat16类型数据转换为向上取整的有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int __bfloat162int_ru(const bfloat16_t x)
```

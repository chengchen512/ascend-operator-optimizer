# \_\_bfloat162ull\_rna<a name="ZH-CN_TOPIC_0000002544960103"></a>
...
将bfloat16类型数据转换为向远离零方向舍入的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __bfloat162ull_rna(const bfloat16_t x)
```
...
输入转换为向远离零方向舍入的64位无符号整数。特别场景说明如下：

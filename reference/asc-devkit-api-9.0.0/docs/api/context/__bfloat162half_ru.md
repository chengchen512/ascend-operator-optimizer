# \_\_bfloat162half\_ru<a name="ZH-CN_TOPIC_0000002533189851"></a>
...
将bfloat16类型数据转换为向上取整的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __bfloat162half_ru(const bfloat16_t x)
```

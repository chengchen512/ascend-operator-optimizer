# \_\_ll2half\_rd<a name="ZH-CN_TOPIC_0000002501269994"></a>
...
将int64类型数据向下取整转换为half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ll2half_rd(const long long int x)
```

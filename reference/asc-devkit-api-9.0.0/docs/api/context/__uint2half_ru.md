# \_\_uint2half\_ru<a name="ZH-CN_TOPIC_0000002501269968"></a>
...
将uint32类型数据向上取整转换为half。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __uint2half_ru(const unsigned int x)
```

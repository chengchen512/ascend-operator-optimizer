# \_\_half2ll\_rn<a name="ZH-CN_TOPIC_0000002501269952"></a>
...
将half类型数据转换为有符号64位整数，并四舍五入到最接近的偶数位。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __half2ll_rn(const half x)
```
...
输入转换为有符号64位整数，并四舍五入到最接近的偶数位的结果。特别场景说明如下：

# \_\_ull2bfloat16\_rn<a name="ZH-CN_TOPIC_0000002533069843"></a>
...
将uint64类型数据转换为bfloat16类型数据，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __ull2bfloat16_rn(const unsigned long long int x)
```
...
输入的uint64数据转换成的bfloat16数据，并四舍五入到最接近的偶数。

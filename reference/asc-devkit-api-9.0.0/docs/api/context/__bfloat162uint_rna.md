# \_\_bfloat162uint\_rna<a name="ZH-CN_TOPIC_0000002513360134"></a>
...
将bfloat16类型数据转换为向远离零方向舍入的无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned int __bfloat162uint_rna(const bfloat16_t x)
```
...
输入转换为向远离零方向舍入的无符号整数的结果。特别场景说明如下：

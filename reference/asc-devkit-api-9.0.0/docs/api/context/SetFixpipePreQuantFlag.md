# SetFixpipePreQuantFlag<a name="ZH-CN_TOPIC_0000001834740629"></a>
...
<tr id="row213775120433"><td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.1 "><p id="p7743750164"><a name="p7743750164"></a><a name="p7743750164"></a><span id="ph171873262101"><a name="ph171873262101"></a><a name="ph171873262101"></a>Kirin X90</span></p>
</td>
...
<tr id="row1531545313433"><td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.1 "><p id="p277014435153"><a name="p277014435153"></a><a name="p277014435153"></a><span id="ph081875221011"><a name="ph081875221011"></a><a name="ph081875221011"></a>Kirin  9030</span></p>
</td>
...
[DataCopy](随路量化激活搬运.md)（CO1-\>GM、CO1-\>A1）过程中进行随路量化时，通过调用该接口设置量化流程中标量量化参数。
...
<td class="cellrowborder" valign="top" width="72.28722872287229%" headers="mcps1.2.4.1.3 "><p id="p169681538125014"><a name="p169681538125014"></a><a name="p169681538125014"></a>量化过程中使用到的标量量化参数。</p>
</td>
</tr>
</tbody>
</table>
...
## 约束说明<a name="section7891710378"></a>

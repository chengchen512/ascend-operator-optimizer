# \_\_int2float\_rn<a name="ZH-CN_TOPIC_0000002501429824"></a>
...
将int32类型数据转换为浮点数，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __int2float_rn(const int x)
```
...
输入的int32数据转换成的浮点数，并四舍五入到最接近的偶数。

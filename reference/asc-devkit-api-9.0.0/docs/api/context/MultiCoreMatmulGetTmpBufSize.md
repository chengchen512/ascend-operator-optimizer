# MultiCoreMatmulGetTmpBufSize<a name="ZH-CN_TOPIC_0000001649330417"></a>

## 功能说明<a name="section618mcpsimp"></a>

多核Matmul Tiling调用[GetTiling](GetTiling.md)接口获取Tiling参数后，根据Tiling结构体信息获取L1 Buffer/Unified Buffer/L0C Buffer的使用大小。
...
<td class="cellrowborder" valign="top" width="72.99%" headers="mcps1.2.4.1.3 "><p id="p16365117193617"><a name="p16365117193617"></a><a name="p16365117193617"></a>Matmul多核Tiling的结构体，即MultiCoreMatmulTiling对象得到的TCubeTiling结构体。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="72.99%" headers="mcps1.2.4.1.3 "><p id="p1150725719147"><a name="p1150725719147"></a><a name="p1150725719147"></a>根据TCubeTiling结构体信息获取<span id="ph17260102915189"><a name="ph17260102915189"></a><a name="ph17260102915189"></a>L1 Buffer</span>/<span id="ph193527427184"><a name="ph193527427184"></a><a name="ph193527427184"></a>Unified Buffer</span>/<span id="ph4282125317181"><a name="ph4282125317181"></a><a name="ph4282125317181"></a>L0C Buffer</span>的使用大小。SysTilingTempBufSize结构定义如下：</p>

# add\_volatile<a name="ZH-CN_TOPIC_0000002510295204"></a>
...
<td class="cellrowborder" valign="top" width="80.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p366123884018"><a name="p366123884018"></a><a name="p366123884018"></a><span>需要处理的类型</span>，<span>包括基本类型（如</span>int<span>、</span>float<span>等）、复合类型（如数组、指针、引用）、用户自定义类型（如类、结构体等），以及带有</span>volatile<span>限定符的类型。</span></p>
</td>
</tr>
</tbody>
</table>

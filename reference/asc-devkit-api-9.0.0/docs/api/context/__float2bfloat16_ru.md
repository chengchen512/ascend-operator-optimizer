# \_\_float2bfloat16\_ru<a name="ZH-CN_TOPIC_0000002533026437"></a>
...
```
__simt_callee__ inline bfloat16_t __float2bfloat16_ru(const float x)
```
...
将输入转换为bfloat16精度并向上取整的结果。特别场景说明如下：

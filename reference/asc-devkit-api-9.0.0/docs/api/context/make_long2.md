# make\_long2<a name="ZH-CN_TOPIC_0000002514807688"></a>
...
```
__simt_callee__ inline long2 make_long2(long int x, long int y)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_long2(__gm__ long2* dst, __gm__ long int* x, __gm__ long int* y)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_long2(x[idx], y[idx]);
}
```

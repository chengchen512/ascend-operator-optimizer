# \_\_float2bfloat16\_rna<a name="ZH-CN_TOPIC_0000002513200206"></a>
...
```
__simt_callee__ inline bfloat16_t __float2bfloat16_rna(const float x)
```
...
将输入转换为bfloat16精度并向远离零方向舍入的结果。特别场景说明如下：

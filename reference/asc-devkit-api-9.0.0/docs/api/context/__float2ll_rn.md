# \_\_float2ll\_rn<a name="ZH-CN_TOPIC_0000002533189831"></a>
...
```
__simt_callee__ inline long long int __float2ll_rn(const float x)
```
...
将输入转换为有符号64位整数，并四舍五入到最接近的偶数。特别场景说明如下：

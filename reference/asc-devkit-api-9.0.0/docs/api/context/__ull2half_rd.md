# \_\_ull2half\_rd<a name="ZH-CN_TOPIC_0000002501269980"></a>
...
将uint64类型数据向下取整转换为half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ull2half_rd(const unsigned long long int x)
```

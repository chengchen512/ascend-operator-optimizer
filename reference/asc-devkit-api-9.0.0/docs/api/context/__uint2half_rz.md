# \_\_uint2half\_rz<a name="ZH-CN_TOPIC_0000002533069825"></a>
...
将uint32类型数据转换为向零舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __uint2half_rz(const unsigned int x)
```

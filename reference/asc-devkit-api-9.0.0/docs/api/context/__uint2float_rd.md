# \_\_uint2float\_rd<a name="ZH-CN_TOPIC_0000002533189861"></a>
...
将uint32类型数据向下取整转换为浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __uint2float_rd(const unsigned int x)
```

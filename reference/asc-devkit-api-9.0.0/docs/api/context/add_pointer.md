# add\_pointer<a name="ZH-CN_TOPIC_0000002541735203"></a>
...
<td class="cellrowborder" valign="top" width="80.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p366123884018"><a name="p366123884018"></a><a name="p366123884018"></a><span>需要处理的类型</span>，<span>包括基本类型（如</span>int<span>、</span>float<span>等）、复合类型（如数组、引用）以及带有指针限定符的类型。</span></p>
</td>
</tr>
</tbody>
</table>

# \_\_int2half\_rd<a name="ZH-CN_TOPIC_0000002533189869"></a>
...
将int32类型数据向下取整为half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_rd(const int x)
```

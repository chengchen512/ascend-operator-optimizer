# GetBitwiseAndTmpBufferFactorSize<a name="ZH-CN_TOPIC_0000002419363333"></a>
...
<tbody><tr id="row2969191210211"><td class="cellrowborder" valign="top" width="16.89%" headers="mcps1.2.4.1.1 "><p id="p0106517325"><a name="p0106517325"></a><a name="p0106517325"></a>ascendcPlatform</p>
</td>
<td class="cellrowborder" valign="top" width="13.19%" headers="mcps1.2.4.1.2 "><p id="p18106117526"><a name="p18106117526"></a><a name="p18106117526"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="69.92%" headers="mcps1.2.4.1.3 "><p id="p16106141719220"><a name="p16106141719220"></a><a name="p16106141719220"></a>输入的平台信息。PlatformAscendC的定义请参见<a href="构造及析构函数.md">构造及析构函数</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="69.92%" headers="mcps1.2.4.1.3 "><p id="p6979417154719"><a name="p6979417154719"></a><a name="p6979417154719"></a>输入的数据类型大小，单位为字节。比如输入的数据类型为uint16_t，此处应传入2。</p>
</td>
</tr>

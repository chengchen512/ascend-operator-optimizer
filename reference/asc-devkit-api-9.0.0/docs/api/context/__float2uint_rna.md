# \_\_float2uint\_rna<a name="ZH-CN_TOPIC_0000002544960097"></a>
...
将浮点数转换为向远离零方向舍入的无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned int __float2uint_rna(const float x)
```
...
将输入转换为向远离零方向舍入的无符号整数的结果。特别场景说明如下：

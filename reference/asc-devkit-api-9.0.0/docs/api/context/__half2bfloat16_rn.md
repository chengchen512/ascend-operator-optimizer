# \_\_half2bfloat16\_rn<a name="ZH-CN_TOPIC_0000002501269942"></a>
...
将half类型数据转换为bfloat16类型，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __half2bfloat16_rn(const half x)
```
...
输入转换成的bfloat16并四舍五入到最接近的偶数的结果。特别场景说明如下：

# \_\_half2bfloat16\_rd<a name="ZH-CN_TOPIC_0000002533069803"></a>
...
将half类型数据转换为向下取整的bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __half2bfloat16_rd(const half x)
```

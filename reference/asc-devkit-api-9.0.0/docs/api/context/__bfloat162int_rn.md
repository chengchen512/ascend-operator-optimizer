# \_\_bfloat162int\_rn<a name="ZH-CN_TOPIC_0000002501429812"></a>
...
将bfloat16类型数据转换为四舍五入到最接近偶数的有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int __bfloat162int_rn(const bfloat16_t x)
```
...
输入转换为四舍五入到最接近偶数的有符号整数的结果。特别场景说明如下：

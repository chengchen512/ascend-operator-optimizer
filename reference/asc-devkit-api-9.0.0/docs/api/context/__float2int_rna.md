# \_\_float2int\_rna<a name="ZH-CN_TOPIC_0000002544880117"></a>
...
将浮点数转换为向远离零方向舍入的有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int __float2int_rna(const float x)
```
...
将输入转换为向远离零方向舍入的有符号整数的结果。特别场景说明如下：

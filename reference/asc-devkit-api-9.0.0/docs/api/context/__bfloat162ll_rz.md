# \_\_bfloat162ll\_rz<a name="ZH-CN_TOPIC_0000002533069821"></a>
...
将bfloat16类型数据转换为向零舍入的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __bfloat162ll_rz(const bfloat16_t x)
```

# max<a name="ZH-CN_TOPIC_0000002132519646"></a>
...
<td class="cellrowborder" valign="top" width="80.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p13794847182319"><a name="p13794847182319"></a><a name="p13794847182319"></a>输入数据src0的数据类型。当前支持的数据类型为bool、int8_t、uint8_t、int16_t、uint16_t、int32_t、uint32_t、float、int64_t、uint64_t。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p1895681215432"><a name="p1895681215432"></a><a name="p1895681215432"></a>输入数据src1的数据类型。当前支持的数据类型为bool、int8_t、uint8_t、int16_t、uint16_t、int32_t、uint32_t、float、int64_t、uint64_t。</p>
<p id="p133490480368"><a name="p133490480368"></a><a name="p133490480368"></a>预留类型，当前必须与T保持一致。</p>
</td>
</tr>
</tbody>
</table>

# \_\_bfloat162int\_rd<a name="ZH-CN_TOPIC_0000002533189855"></a>
...
将bfloat16类型数据转换为向下取整的有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int __bfloat162int_rd(const bfloat16_t x)
```

# \_\_half2ull\_rn<a name="ZH-CN_TOPIC_0000002501269950"></a>
...
将half类型数据转换为无符号64位整数，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __half2ull_rn(const half x)
```
...
输入转换为无符号64位整数，并四舍五入到最接近的偶数的结果。特别场景说明如下：

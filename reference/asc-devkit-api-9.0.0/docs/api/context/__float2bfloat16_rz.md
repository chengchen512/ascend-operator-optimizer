# \_\_float2bfloat16\_rz<a name="ZH-CN_TOPIC_0000002533146477"></a>
...
```
__simt_callee__ inline bfloat16_t __float2bfloat16_rz(const float x)
```
...
将输入转换为bfloat16精度并向零舍入的结果。特别场景说明如下：

# \_\_bfloat162ll\_rn<a name="ZH-CN_TOPIC_0000002501429816"></a>
...
将bfloat16类型数据转换为四舍五入到最接近偶数的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __bfloat162ll_rn(const bfloat16_t x)
```
...
输入转换为四舍五入到最接近偶数的64位的有符号整数。特别场景说明如下：

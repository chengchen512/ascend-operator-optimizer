# \_\_half2ll\_rz<a name="ZH-CN_TOPIC_0000002501429806"></a>
...
将half类型数据转换为向零舍入的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __half2ll_rz(const half x)
```
...
输入转换为向零舍入的64位有符号整数的结果。特别场景说明如下：

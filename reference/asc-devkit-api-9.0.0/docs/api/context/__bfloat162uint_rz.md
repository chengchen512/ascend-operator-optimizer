# \_\_bfloat162uint\_rz<a name="ZH-CN_TOPIC_0000002533069815"></a>
...
将bfloat16类型数据转换为向零舍入的无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned int __bfloat162uint_rz(const bfloat16_t x)
```

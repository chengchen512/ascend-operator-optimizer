# \_\_uint2float\_rna<a name="ZH-CN_TOPIC_0000002513360136"></a>
...
将uint32类型数据转换为向远离零方向舍入的浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __uint2float_rna(const unsigned int x)
```
...
将输入的uint32类型数据转换成的向远离零方向舍入的浮点数。

...
用户通过调用[GetTiling](GetTiling-129.md)接口获取TConv3DBpFilterTiling结构体，具体流程请参考[使用说明](Conv3DBackpropFilter-Tiling使用说明.md)。当前暂不支持用户自定义配置TConv3DBpFilterTiling结构体中的参数。

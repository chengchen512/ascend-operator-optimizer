# \_\_ll2half\_ru<a name="ZH-CN_TOPIC_0000002501429850"></a>
...
将int64类型数据转换为向上取整的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ll2half_ru(const long long int x)
```

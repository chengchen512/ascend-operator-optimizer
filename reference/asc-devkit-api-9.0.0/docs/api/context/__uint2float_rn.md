# \_\_uint2float\_rn<a name="ZH-CN_TOPIC_0000002501429818"></a>
...
将uint32类型数据转换为浮点数，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __uint2float_rn(const unsigned int x)
```
...
输入的无符号整数转换成的浮点数，并四舍五入到最接近的偶数。

## 约束说明<a name="section633mcpsimp"></a>

无

## 需要包含的头文件<a name="section17526121094019"></a>

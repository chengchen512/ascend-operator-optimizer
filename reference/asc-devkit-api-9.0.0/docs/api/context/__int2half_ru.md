# \_\_int2half\_ru<a name="ZH-CN_TOPIC_0000002501269974"></a>
...
将int32类型数据向上取整转换为half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_ru(const int x)
```

# \_\_bfloat162ull\_ru<a name="ZH-CN_TOPIC_0000002501269962"></a>
...
将bfloat16类型数据转换为向上取整的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __bfloat162ull_ru(const bfloat16_t x)
```

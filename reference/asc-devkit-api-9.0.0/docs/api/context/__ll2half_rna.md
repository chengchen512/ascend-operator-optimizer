# \_\_ll2half\_rna<a name="ZH-CN_TOPIC_0000002544960109"></a>
...
将int64类型数据转换为向远离零方向舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ll2half_rna(const long long int x)
```

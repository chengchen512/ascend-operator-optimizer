# \_\_float2ll\_rna<a name="ZH-CN_TOPIC_0000002513200208"></a>
...
将浮点数转换为向远离零方向舍入的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __float2ll_rna(const float x)
```
...
将浮点数转换为向远离零方向舍入的64位有符号整数的结果。特别场景说明如下：

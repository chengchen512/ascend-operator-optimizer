# \_\_uint2half\_rd<a name="ZH-CN_TOPIC_0000002533189863"></a>
...
将uint32类型数据向下取整为half类型。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __uint2half_rd(const unsigned int x)
```

# asc\_atomic\_inc<a name="ZH-CN_TOPIC_0000002516936281"></a>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.2.4.1.3 "><p id="p997154617392"><a name="p997154617392"></a><a name="p997154617392"></a><span id="ph10389112463510"><a name="ph10389112463510"></a><a name="ph10389112463510"></a>Unified Buffer</span>或<span id="ph1744110199399"><a name="ph1744110199399"></a><a name="ph1744110199399"></a>Global Memory</span>的地址。</p>
</td>
</tr>
<tr id="row19788825183314"><td class="cellrowborder" valign="top" width="12.889999999999999%" headers="mcps1.2.4.1.1 "><p id="p6255648487"><a name="p6255648487"></a><a name="p6255648487"></a>val</p>
</td>
...
```
template <typename T>
__simt_vf__ __launch_bounds__(1024) inline void KernelAtomicInc(__gm__ uint32_t* dst, __gm__ uint32_t* src)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    asc_atomic_inc(dst + idx, src[idx]);
}
```

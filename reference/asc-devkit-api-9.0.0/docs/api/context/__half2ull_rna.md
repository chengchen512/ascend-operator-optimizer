# \_\_half2ull\_rna<a name="ZH-CN_TOPIC_0000002513200210"></a>
...
将half类型数据转换为向远离零方向舍入的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __half2ull_rna(const half x)
```
...
输入转换为向远离零方向舍入的64位无符号整数的结果。特别场景说明如下：

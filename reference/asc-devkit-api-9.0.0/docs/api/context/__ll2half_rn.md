# \_\_ll2half\_rn<a name="ZH-CN_TOPIC_0000002533069853"></a>
...
将int64类型数据转换为四舍五入到最接近偶数的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ll2half_rn(const long long int x)
```
...
输入的int64数据转换成的四舍五入到最接近偶数的half数据。

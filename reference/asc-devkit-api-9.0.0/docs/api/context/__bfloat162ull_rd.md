# \_\_bfloat162ull\_rd<a name="ZH-CN_TOPIC_0000002533189857"></a>

## 产品支持情况<a name="section0609153010484"></a>
...
将bfloat16类型数据转换为向下取整的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __bfloat162ull_rd(const bfloat16_t x)
```

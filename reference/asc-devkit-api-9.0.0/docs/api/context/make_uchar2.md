# make\_uchar2<a name="ZH-CN_TOPIC_0000002514807682"></a>
...
```
__simt_callee__ inline uchar2 make_uchar2(unsigned char x, unsigned char y)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_uchar2(__gm__ uchar2* dst, __gm__ unsigned char* x, __gm__ unsigned char* y)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_uchar2(x[idx], y[idx]);
}
```

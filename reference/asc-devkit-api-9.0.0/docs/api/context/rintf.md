# rintf<a name="ZH-CN_TOPIC_0000002518950617"></a>
...
## 约束说明<a name="section142976202101"></a>
...
## 调用示例<a name="section182979207107"></a>

```
__simt_vf__ __launch_bounds__(1024) inline void KernelRint(__gm__ float* dst, __gm__ float* x)
{

# \_\_half2bfloat16\_rna<a name="ZH-CN_TOPIC_0000002544960099"></a>
...
将half类型数据转换为向远离零方向舍入的bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __half2bfloat16_rna(const half x)
```
...
输入向远离零方向舍入转换成的bfloat16数据。特别场景说明如下：

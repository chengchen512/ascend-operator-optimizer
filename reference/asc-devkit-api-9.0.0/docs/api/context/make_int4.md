# make\_int4<a name="ZH-CN_TOPIC_0000002546487553"></a>
...
```
__simt_callee__ inline int4 make_int4(int x, int y, int z, int w)
```
...
<tr id="row18199124714617"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.2.4.1.1 "><p id="p372213511365"><a name="p372213511365"></a><a name="p372213511365"></a>z</p>
</td>
...
<tr id="row1957519507611"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.2.4.1.1 "><p id="p472225118617"><a name="p472225118617"></a><a name="p472225118617"></a>w</p>
</td>
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_int4(__gm__ int4* dst, __gm__ int* x, __gm__ int* y, __gm__ int* z, __gm__ int* w )
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_int4(x[idx], y[idx], z[idx], w[idx]);
}
```

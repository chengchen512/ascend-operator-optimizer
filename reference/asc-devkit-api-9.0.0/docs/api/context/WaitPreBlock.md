...
通过读GM地址中的值，确认是否需要继续等待，当GM的值满足当前核的等待条件时，该核即可往下执行，进行下一步操作。使用接口前，请确保已经调用[InitDetermineComputeWorkspace](InitDetermineComputeWorkspace.md)接口，初始化共享内存。
...
<td class="cellrowborder" valign="top" width="73.74737473747375%" headers="mcps1.2.4.1.3 "><p id="p6538259172913"><a name="p6538259172913"></a><a name="p6538259172913"></a>临时空间，通过读取gmWorkspace，判断当前核是否可以继续往下执行，类型为GlobalTensor。</p>
</td>
</tr>

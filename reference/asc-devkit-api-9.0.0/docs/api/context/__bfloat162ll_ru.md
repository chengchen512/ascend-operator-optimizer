# \_\_bfloat162ll\_ru<a name="ZH-CN_TOPIC_0000002501269964"></a>
...
将bfloat16类型数据转换为向上取整的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __bfloat162ll_ru(const bfloat16_t x)
```

# \_\_uint2bfloat16\_rn<a name="ZH-CN_TOPIC_0000002501429822"></a>
...
将uint32类型数据转换为bfloat16类型，并四舍五入到最接近的偶数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __uint2bfloat16_rn(const unsigned int x)
```
...
输入的uint32数据转换成的bfloat16数据，并四舍五入到最接近的偶数。

# asc\_reduce\_add<a name="ZH-CN_TOPIC_0000002516816303"></a>
...
```
__simt_callee__ inline half asc_reduce_add(half val)
```
...
```
__simt_vf____launch_bounds__(1024) inline void KernelReduceAdd(__gm__ int32_t* dst)
{

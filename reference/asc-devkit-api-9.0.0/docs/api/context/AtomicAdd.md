# AtomicAdd<a name="ZH-CN_TOPIC_0000002186262066"></a>
...
<table><thead align="left"><tr id="row105531513121315"><th class="cellrowborder" valign="top" width="8.88%" id="mcps1.2.4.1.1"><p id="p1663233972817"><a name="p1663233972817"></a><a name="p1663233972817"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="9.87%" id="mcps1.2.4.1.2"><p id="zh-cn_topic_0235751031_p16609919"><a name="zh-cn_topic_0235751031_p16609919"></a><a name="zh-cn_topic_0235751031_p16609919"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="81.25%" id="mcps1.2.4.1.3"><p id="p663216395286"><a name="p663216395286"></a><a name="p663216395286"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="row5553201314135"><td class="cellrowborder" valign="top" width="8.88%" headers="mcps1.2.4.1.1 "><p id="p284425844311"><a name="p284425844311"></a><a name="p284425844311"></a>address</p>
</td>
<td class="cellrowborder" valign="top" width="9.87%" headers="mcps1.2.4.1.2 "><p id="p158449584436"><a name="p158449584436"></a><a name="p158449584436"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="81.25%" headers="mcps1.2.4.1.3 "><p id="p6389114616514"><a name="p6389114616514"></a><a name="p6389114616514"></a>输入GM的地址。</p>
</td>
</tr>
<tr id="row6553613191315"><td class="cellrowborder" valign="top" width="8.88%" headers="mcps1.2.4.1.1 "><p id="p6255648487"><a name="p6255648487"></a><a name="p6255648487"></a>value</p>
</td>
<td class="cellrowborder" valign="top" width="9.87%" headers="mcps1.2.4.1.2 "><p id="p182559481483"><a name="p182559481483"></a><a name="p182559481483"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="81.25%" headers="mcps1.2.4.1.3 "><p id="p62551148687"><a name="p62551148687"></a><a name="p62551148687"></a>标量值，支持数据类型和address指向的数据类型保持一致。</p>
</td>
</tr>
</tbody>
</table>
...
extern "C" __global__ __aicore__ void atomic_simple_kernel(__gm__ uint8_t* dst， uint32_t dataSize)
{
    ...
    int32_t value = 1;
    int32_t a = AscendC::AtomicAdd(reinterpret_cast<__gm__ int32_t *>(dst), value);
...
返回值 a: 1
核2：
原子计算后GM数据dst: [3,1,1,1,1,...,1] 
返回值 a: 2
核3：
原子计算后GM数据dst: [4,1,1,1,1,...,1] 
返回值 a: 3
```

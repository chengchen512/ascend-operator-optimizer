# \_\_uint2bfloat16\_rz<a name="ZH-CN_TOPIC_0000002533069827"></a>
...
将uint32类型数据转换为向零舍入的bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __uint2bfloat16_rz(const unsigned int x)
```
...
输入的uint32数据转换成的向零舍入的bfloat16数据。

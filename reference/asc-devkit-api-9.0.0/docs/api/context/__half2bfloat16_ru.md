# \_\_half2bfloat16\_ru<a name="ZH-CN_TOPIC_0000002533189837"></a>
...
将half类型数据转换为向上取整的bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __half2bfloat16_ru(const half x)
```
...
输入转换成的向上取整的bfloat16数据。特别场景说明如下：

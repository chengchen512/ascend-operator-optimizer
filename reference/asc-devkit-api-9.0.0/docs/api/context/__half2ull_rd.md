# \_\_half2ull\_rd<a name="ZH-CN_TOPIC_0000002533069809"></a>
...
将half类型数据转换为向下取整的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __half2ull_rd(const half x)
```
...
输入转换为向下取整的64位无符号整数的结果。特别场景说明如下：

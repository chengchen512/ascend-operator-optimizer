# \_\_ull2float\_rna<a name="ZH-CN_TOPIC_0000002544960107"></a>
...
将uint64类型数据转换为向远离零方向舍入的浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __ull2float_rna(const unsigned long long int x)
```

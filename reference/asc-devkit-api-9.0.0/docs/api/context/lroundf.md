# lroundf<a name="ZH-CN_TOPIC_0000002486821078"></a>
...
```
__simt_vf__ __launch_bounds__(1024) inline void KernelRound(__gm__ long int* dst, __gm__ float* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = lroundf(x[idx]);
}
```

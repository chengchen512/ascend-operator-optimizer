# \_\_ull2half\_rz<a name="ZH-CN_TOPIC_0000002533189877"></a>
...
将uint64类型数据转换为向零舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ull2half_rz(const unsigned long long int x))
```

# make\_ushort2<a name="ZH-CN_TOPIC_0000002546487541"></a>
...
```
__simt_callee__ inline ushort2 make_ushort2(unsigned short x, unsigned short y)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_ushort2(__gm__ ushort2* dst, __gm__ unsigned short* x, __gm__ unsigned short* y)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_ushort2(x[idx], y[idx]);
}
```

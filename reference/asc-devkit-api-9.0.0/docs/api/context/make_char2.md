# make\_char2<a name="ZH-CN_TOPIC_0000002546465211"></a>
...
```
__simt_callee__ inline char2 make_char2(signed char x, signed char y)
```
...
```
__simt_vf__ __launch_bounds__(1024) inline void kernel_make_char2(__gm__ char2* dst, __gm__ signed char* x, __gm__ signed char* y)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = make_char2(x[idx], y[idx]);
}
```

# \_\_half2ll\_rna<a name="ZH-CN_TOPIC_0000002544960101"></a>
...
将half类型数据转换为向远离零方向舍入的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __half2ll_rna(const half x)
```
...
输入转换为向远离零方向舍入的64位有符号整数的结果。特别场景说明如下：

# \_\_half2bfloat16\_rz<a name="ZH-CN_TOPIC_0000002501429794"></a>
...
将half类型数据转换为向零舍入的bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __half2bfloat16_rz(const half x)
```

...
<td class="cellrowborder" valign="top" width="28.202820282028203%" headers="mcps1.2.4.1.2 "><p id="p19799174315815"><a name="p19799174315815"></a><a name="p19799174315815"></a>该组模板参数组合用于配置是否使能确定性计算。</p>
</td>
...
<p id="p1937103317239"><a name="p1937103317239"></a><a name="p1937103317239"></a>备注：若通过ASCENDC_TPL_DETERMINISTIC_SEL(true)接口编译出了确定性计算的版本，在算子调用时，通常需要打开确定性计算的的开关，例如通过aclnn单算子调用时，需要使用aclrtCtxSetSysParamOpt接口进行相关配置。</p>

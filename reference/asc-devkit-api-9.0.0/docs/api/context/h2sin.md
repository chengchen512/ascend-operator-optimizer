# h2sin<a name="ZH-CN_TOPIC_0000002513334332"></a>
...
```
__simt_callee__ inline half2 h2sin(half2 x)
```

```
__simt_callee__ inline bfloat16x2_t h2sin(bfloat16x2_t x)
```
...
-   调用示例一：
    ...
    ```
    bfloat16x2_t x = {0, 0};
    bfloat16x2_t result = h2sin(x); // 返回值为{0, 0}
    ```

# \_\_ll2half\_rz<a name="ZH-CN_TOPIC_0000002533189895"></a>
...
将int64类型数据转换为向零舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ll2half_rz(const long long int x)
```

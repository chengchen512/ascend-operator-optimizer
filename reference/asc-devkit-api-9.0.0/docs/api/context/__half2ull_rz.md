# \_\_half2ull\_rz<a name="ZH-CN_TOPIC_0000002501429802"></a>
...
将half类型数据转换为向零舍入的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __half2ull_rz(const half x)
```
...
输入转换为向零舍入的64位无符号整数的结果。特别场景说明如下：

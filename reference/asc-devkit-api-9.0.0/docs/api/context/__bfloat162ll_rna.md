# \_\_bfloat162ll\_rna<a name="ZH-CN_TOPIC_0000002544880123"></a>
...
将bfloat16类型数据转换为向远离零方向舍入的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __bfloat162ll_rna(const bfloat16_t x)
```
...
输入转换为向远离零方向舍入的64位的有符号整数。特别场景说明如下：

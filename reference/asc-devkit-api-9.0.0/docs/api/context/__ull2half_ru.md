# \_\_ull2half\_ru<a name="ZH-CN_TOPIC_0000002501429838"></a>
...
将uint64类型数据向上取整转换为浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __ull2half_ru(const unsigned long long int x)
```

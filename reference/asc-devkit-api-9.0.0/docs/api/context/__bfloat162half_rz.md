# \_\_bfloat162half\_rz<a name="ZH-CN_TOPIC_0000002501429808"></a>
...
将bfloat16类型数据转换为向零舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __bfloat162half_rz(const bfloat16_t x)
```

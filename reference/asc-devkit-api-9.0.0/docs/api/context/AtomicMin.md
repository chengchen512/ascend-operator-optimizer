# AtomicMin<a name="ZH-CN_TOPIC_0000002221468105"></a>
...
<table><thead align="left"><tr id="row105531513121315"><th class="cellrowborder" valign="top" width="8.6%" id="mcps1.2.4.1.1"><p id="p1663233972817"><a name="p1663233972817"></a><a name="p1663233972817"></a>参数名</p>
</th>
...
<th class="cellrowborder" valign="top" width="81.33%" id="mcps1.2.4.1.3"><p id="p663216395286"><a name="p663216395286"></a><a name="p663216395286"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="row5553201314135"><td class="cellrowborder" valign="top" width="8.6%" headers="mcps1.2.4.1.1 "><p id="p284425844311"><a name="p284425844311"></a><a name="p284425844311"></a>address</p>
</td>
...
<td class="cellrowborder" valign="top" width="81.33%" headers="mcps1.2.4.1.3 "><p id="p6389114616514"><a name="p6389114616514"></a><a name="p6389114616514"></a>输入GM的地址。</p>
</td>
</tr>
<tr id="row6553613191315"><td class="cellrowborder" valign="top" width="8.6%" headers="mcps1.2.4.1.1 "><p id="p6255648487"><a name="p6255648487"></a><a name="p6255648487"></a>value</p>
</td>
...
<td class="cellrowborder" valign="top" width="81.33%" headers="mcps1.2.4.1.3 "><p id="p62551148687"><a name="p62551148687"></a><a name="p62551148687"></a>标量值，支持数据类型和address指向的数据类型保持一致。</p>
</td>
</tr>
</tbody>
</table>
...
extern "C" __global__ __aicore__ void atomic_simple_kernel(__gm__ uint8_t* dst， uint32_t dataSize)
{
    ...
    int32_t value = 0;
    int32_t a = AscendC::AtomicMin(reinterpret_cast<__gm__ int32_t *>(dst), value);

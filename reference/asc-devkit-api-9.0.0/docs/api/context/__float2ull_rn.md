# \_\_float2ull\_rn<a name="ZH-CN_TOPIC_0000002533069795"></a>
...
将浮点数转换为四舍五入至最接近偶数的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __float2ull_rn(const float x)
```
...
将输入转换为四舍五入到最接近偶数的64位无符号整数。特别场景说明如下：

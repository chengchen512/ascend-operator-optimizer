# \_\_bfloat162int\_rz<a name="ZH-CN_TOPIC_0000002533069817"></a>
...
将bfloat16类型数据转换为向零舍入的有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline int __bfloat162int_rz(const bfloat16_t x)
```

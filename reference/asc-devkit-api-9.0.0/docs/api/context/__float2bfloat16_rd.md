# \_\_float2bfloat16\_rd<a name="ZH-CN_TOPIC_0000002501226568"></a>
...
```
__simt_callee__ inline bfloat16_t __float2bfloat16_rd(const float x)
```
...
将输入转换为bfloat16精度并向下舍入的结果。特别场景说明如下：

# \_\_int2half\_rz<a name="ZH-CN_TOPIC_0000002533069831"></a>
...
将int32类型数据转换为向零舍入的half类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __int2half_rz(const int x)
```

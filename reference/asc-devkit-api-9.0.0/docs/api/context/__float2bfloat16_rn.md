# \_\_float2bfloat16\_rn<a name="ZH-CN_TOPIC_0000002501386412"></a>
...
```
__simt_callee__ inline bfloat16_t __float2bfloat16_rn(const float x)
```
...
将输入转换为bfloat16精度后四舍五入到最接近的偶数。特别场景说明如下：

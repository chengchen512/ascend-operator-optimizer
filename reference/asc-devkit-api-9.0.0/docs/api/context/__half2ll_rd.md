# \_\_half2ll\_rd<a name="ZH-CN_TOPIC_0000002533069811"></a>
...
将half类型数据转换为向下取整的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __half2ll_rd(const half x)
```

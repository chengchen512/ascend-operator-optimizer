# \_\_float2ull\_rna<a name="ZH-CN_TOPIC_0000002513360130"></a>
...
将浮点数转换为向远离零方向舍入的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __float2ull_rna(const float x)
```
...
将浮点数转换为向远离零方向舍入的64位无符号整数。特别场景说明如下：

# \_\_ll2bfloat16\_ru<a name="ZH-CN_TOPIC_0000002501429854"></a>
...
将int64类型数据转换为向上取整的bfloat16类型数据。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline bfloat16_t __ll2bfloat16_ru(const long long int x)
```

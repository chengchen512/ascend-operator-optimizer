# \_\_int2float\_rd<a name="ZH-CN_TOPIC_0000002533189867"></a>
...
将int32类型数据向下取整转换为浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __int2float_rd(const int x)
```

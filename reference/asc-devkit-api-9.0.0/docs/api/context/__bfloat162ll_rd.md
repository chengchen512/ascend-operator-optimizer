# \_\_bfloat162ll\_rd<a name="ZH-CN_TOPIC_0000002533189859"></a>
...
将bfloat16类型数据转换为向下取整的64位有符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline long long int __bfloat162ll_rd(const bfloat16_t x)
```

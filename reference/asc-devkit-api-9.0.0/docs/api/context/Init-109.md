# Init<a name="ZH-CN_TOPIC_0000002068202754"></a>
...
Init主要用于对Conv3DBackpropInput对象中的Tiling数据进行初始化，根据Tiling参数进行资源划分，Tiling参数的具体介绍请参考[Conv3DBackpropInput Tiling侧接口](Conv3DBackpropInput-Tiling侧接口.md)。
...
<td class="cellrowborder" valign="top" width="70.43%" headers="mcps1.2.4.1.3 "><p id="p13481914175514"><a name="p13481914175514"></a><a name="p13481914175514"></a>Conv3DBackpropInput对象的Tiling参数，TConv3DBackpropInputTiling结构体的定义请参见<a href="TConv3DBackpropInputTiling结构体.md">TConv3DBackpropInputTiling结构体</a>。</p>
<p id="p246271553317"><a name="p246271553317"></a><a name="p246271553317"></a>Tiling参数可以通过Host侧<a href="GetTiling-115.md">GetTiling</a>接口获取，并传递到Kernel侧使用。</p>
</td>
</tr>
</tbody>
</table>

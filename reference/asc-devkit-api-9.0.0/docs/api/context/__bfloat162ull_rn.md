# \_\_bfloat162ull\_rn<a name="ZH-CN_TOPIC_0000002501429814"></a>
...
将bfloat16类型数据转换为四舍五入到最接近偶数的64位无符号整数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline unsigned long long int __bfloat162ull_rn(const bfloat16_t x)
```
...
输入转换为四舍五入到最接近偶数的64位的无符号整数。特别场景说明如下：

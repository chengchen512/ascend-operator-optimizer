# \_\_uint2float\_rz<a name="ZH-CN_TOPIC_0000002533069823"></a>
...
将uint32类型数据转换为向零舍入的浮点数。

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline float __uint2float_rz(const unsigned int x)
```
